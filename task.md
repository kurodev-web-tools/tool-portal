...
- PR #687 is merged at current integration tip `945efbcb5bf8053288bf4a8326ff3e21e00d116f`; reviewed head `5c37104fe19d9e77bf2d7d6061bbcb4b020806cb` is contained in integration. S2AP remains consumed/pass. The current local follow-up adds a single-use injected adapter/read consumer and proves `4/4` synthetic fixtures GREEN without real adapter/client or remote/deployed execution.
