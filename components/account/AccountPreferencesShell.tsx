...
const accountCopy = {
  ja: {
    eyebrow: "アカウント設定",
    title: "アカウントと表示設定",
    lead: "表示言語とテーマは未ログインでもこのブラウザで使えます。ログインすると、同じ設定をアカウントにも保存できます。",
    authSignedOut: "未ログイン",
    authSignedIn: "ログイン中",
    authUnavailable: "アカウント設定待ち",
    authBody: "初期公開版では、表示設定の保存だけを小さく扱います。制作データや予定は自動でアップロードしません。",
    ...
    preferencesBody: "表示言語とテーマはこのブラウザに保存されます。ログイン中は、同じ内容をアカウントにも明示的に保存できます。",
    language: "表示言語",
    theme: "テーマ",
    browserSaved: "このブラウザに保存",
    syncFrameTitle: "今後保存できるようにする項目",
    syncFrameBody: "今後はツールごとの軽い設定も保存対象にできます。下書き、予定本文、画像、一時的な受け渡しデータは自動では保存しません。",
  ...
  en: {
    ...
    lead: "Language and theme work from this browser even when you are signed out. Sign in to save the same settings to your account.",
    authSignedOut: "Signed out",
    authSignedIn: "Signed in",
    authUnavailable: "Account setup pending",
    authBody: "The first public account version only saves display settings. Creative drafts and schedules are not uploaded automatically.",
    ...
    preferencesBody: "Language and theme are saved in this browser. Signed-in users can explicitly save the same values to the account.",
    language: "Language",
    theme: "Theme",
    browserSaved: "Saved in this browser",
    syncFrameTitle: "Settings that can be saved later",
    syncFrameBody: "Later phases can add lightweight per-tool settings. Drafts, schedule text, images, and temporary handoff data are not saved automatically.",
