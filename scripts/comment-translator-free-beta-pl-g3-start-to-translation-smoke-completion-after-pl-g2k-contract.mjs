...
for (const requiredFragment of [
  ...
  "browser-visible feed durable snapshot boundary",
  "implemented locally / deterministic contract passed / deployed migration apply and browser confirmation not-run",
  "Operator-local Readiness Instructions",
