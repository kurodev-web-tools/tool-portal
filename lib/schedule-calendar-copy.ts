...
export const scheduleCalendarCopy = {
  ja: {
    ...
    aria: {
      previousMonth: "前の月",
      nextMonth: "次の月",
      previousPeriod: "前の期間へ",
      nextPeriod: "次の期間へ",
      selectDate: (dateLabel: string) => `${dateLabel}を選択`,
      showDate: (dateLabel: string) => `${dateLabel}を表示`,
      createEventAt: (timeLabel: string) => `${timeLabel}に新規予定を作成`,
      filterCategory: "カテゴリで絞り込み",
      filterPlatform: "プラットフォームで絞り込み",
      filterPeriod: "期間で絞り込み",
      filterSortOrder: "並び順",
      filterAnnouncementStatus: "告知ステータスで絞り込み",
      ...
      recurrence: "繰り返し",
      addSavedHashtagSet: "予定に追加する保存済みハッシュタグセット",
      closeSchedulePanel: "予定パネルを閉じる",
      dragCloseSchedulePanel: "下にスワイプして予定パネルを閉じる",
      closeUndoToast: "Undo通知を閉じる"
    },
    dragMoveGuide: (startTime: string, endTime: string) => `ここに移動 ${startTime} - ${endTime}`,
    categories: {
      stream: "配信",
      production: "制作",
      post: "投稿",
  ...
  en: {
    ...
    aria: {
      ...
      selectDate: (dateLabel: string) => `Select ${dateLabel}`,
      showDate: (dateLabel: string) => `Show ${dateLabel}`,
      createEventAt: (timeLabel: string) => `Create event at ${timeLabel}`,
      filterCategory: "Filter by category",
      filterPlatform: "Filter by platform",
      filterPeriod: "Filter by date range",
      filterSortOrder: "Sort order",
      filterAnnouncementStatus: "Filter by status",
      usageCategory: "Use category",
      defaultPlatform: "Default platform",
      defaultView: "Default view",
      weekStartsOn: "Week starts on",
      defaultDuration: "Default event duration",
      defaultDurationShort: "Default duration",
      category: "Category",
      platform: "Platform",
      announcementStatus: "Announcement status",
      recurrence: "Repeat",
      addSavedHashtagSet: "Saved hashtag set to add to event",
      closeSchedulePanel: "Close schedule panel",
      dragCloseSchedulePanel: "Swipe down to close schedule panel",
      closeUndoToast: "Close undo notification"
    },
    dragMoveGuide: (startTime: string, endTime: string) => `Move here ${startTime} - ${endTime}`,
    categories: {
      stream: "Stream",
