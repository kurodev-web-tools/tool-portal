...
1. Kuro Live Comment Translator preview branch
   ...
   - branch stack:
     ...
     - active feature: `codex/comment-translator-youtube-credential-status-source-evidence-post-pr311-review` at `D:/V_streamer_tools/.worktrees/comment-translator-youtube-credential-status-source-evidence-post-pr311-review`
   - seed:
   ...
   - current slice target:
     - `post-PR #311 source/evidence review gate` を PR #311 (`[codex] Gate post-PR310 credential source evidence review`) merge 後の follow-up として確認する。
     - 前提 PR #311 は 2026-06-03 に `codex/comment-translator-preview` へ merge 済みで、merge commit `d57a21a9f2c705b541d48f1f4098d71cb31abdee` が `origin/codex/comment-translator-preview` に含まれることを確認した。
     - PR #310 / #309 / #308 / #307 / #306 merge 前提も維持し、merge commit `27968bcf7e9e10e9a9b50d17bf81595d6d5e8601` / `265f5b5a635da35b5bdf70d85f6fc99e35330cb9` / `995261d714a1e01ae08fcdd52ed94c7f96720571` / `3b1a76a8c6b7102bc9c640e9173d016d6a5343d5` / `650917f72963bf82649ec39142e3c54f2db6bc4e` が current branch に含まれることを contract で確認する。
     ...
     - `scripts/comment-translator-youtube-credential-reference-surface-source-recheck-contract.mjs` と `lib/comment-translator-youtube-client-safe-credential-reference-source.ts` の post-PR #311 source/evidence review gate helper で、PR #311 merge 後も source と evidence が両方揃わない状態を `blocked-pr311-source-evidence-review-missing-surfaced-source-or-approval-evidence` として扱う。
