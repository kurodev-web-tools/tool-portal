...
export function CommentTranslatorFeedPanel({ locale, copy, commentOnly, sessionStatus, authorDisplayNamePolicy, searchQuery, statusFilter, statusFilters, priorityFilter, filteredComments, publicCommentCount, translatedCount, displayMode, targetLanguageLabel, isPending, hasRetainedRows, errorMessage, unavailableMessage, onNormalView, onSearchQueryChange, onStatusFilterChange, onPriorityFilterChange, onRefresh, onClear }: {
  ...
  readonly onPriorityFilterChange: (value: CommentTranslatorPriorityFilter) => void;
