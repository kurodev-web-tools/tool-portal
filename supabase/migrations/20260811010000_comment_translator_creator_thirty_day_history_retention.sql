-- Reviewable local NC-X2B-R1 migration only. It is intentionally unapplied.
-- This file changes only the effective safe-history cutoff; migration apply,
-- account observation, deploy, activation, and live history access remain separately approved.
