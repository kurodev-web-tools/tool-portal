...
- Authenticated allowed-tester route/API smoke execution remains not-run / approval-gated even though FB-L3 now has exact-command ready preflight, PL-G2B records the blocked-no-approval harness smoke evidence, PL-G2C records the post-PL-G5 keep blocked / blocked-no-approval follow-up, and PL-G2D records the post-PL-G5-follow-up keep blocked / blocked-no-approval recheck.
