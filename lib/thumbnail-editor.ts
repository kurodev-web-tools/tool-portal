...
export const thumbnailPresets: ThumbnailPreset[] = [
  ...
  },
  {
    ...
    layers: [
      ...
      assetDecorationLayer({ name: "画像 7（時刻カード土台）", src: `${thumbnailPhase5DecorationAssetPrefix}project-stream-time-badge-coral-uniform-cell.png`, x: 438, y: 524, width: 461, height: 243, rotation: -1, opacity: 0.98 }),
