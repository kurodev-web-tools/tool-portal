...
assert.match(
  task,
  /Current branch: `codex\/comment-translator-free-beta-pl-g2(?:f-route-api-harness-smoke-execution-gate-after-pl-g2e|g-route-api-harness-smoke-execution-after-pl-g2f|h-approved-route-api-harness-smoke-execution-after-pl-g2g|i-approved-route-api-harness-smoke-execution-after-pl-g2h)`/i,
  "task.md records PL-G2F, PL-G2G, PL-G2H, or PL-G2I branch"
);
