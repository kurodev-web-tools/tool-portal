...
assert.match(
  task,
  /Current branch: `codex\/comment-translator-free-beta-pl-g2(?:h-approved-route-api-harness-smoke-execution-after-pl-g2g|i-approved-route-api-harness-smoke-execution-after-pl-g2h|j-approved-route-api-harness-smoke-execution-after-pl-g2i|k-approved-route-api-harness-smoke-execution-after-pl-g2j)`/i,
  "task.md records PL-G2H PL-G2I, PL-G2J, or PL-G2K branch"
);
