...
const commentTranslatorPageSource = fs.readFileSync(path.join(root, "app", "tools", "comment-translator", "page.tsx"), "utf8");
...
assert.equal(commentTranslatorTool.suite, "stream-workflow", "comment translator belongs to stream workflow suite");
assert.equal(commentTranslatorTool.category, "stream", "comment translator keeps the stream category");
