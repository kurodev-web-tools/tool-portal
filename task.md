...
- Current branch: `codex/pre-public-diagnostics-skip-feed`.
- Base: latest `origin/codex/comment-translator-free-public-beta-integration`.
- Scope: Free beta pre-public diagnostics UI plus target-language language-policy skip feed suppression.
