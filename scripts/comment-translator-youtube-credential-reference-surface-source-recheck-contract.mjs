...
assert.match(taskSource, /post-PR #309 source\/evidence review gate/i, "task.md records the current post-PR #309 source/evidence review gate target");
...
for (const file of changedFiles()) {
  assert.ok(allowedChangedFiles.has(file), `PR #306 recheck change stays in allowed files: ${file}`);
