...
for (const file of changedFiles()) {
  assert.ok(allowedChangedFiles.has(file) || plG6dChangedFiles.has(file) || activeSessionStartReadinessChangedFiles.has(file), `F7 change stays in allowed files: ${file}`);
}
