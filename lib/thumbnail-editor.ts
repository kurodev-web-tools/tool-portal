...
export const thumbnailPresets: ThumbnailPreset[] = [
  ...
  },
  {
    ...
    layers: [
      ...
      assetDecorationLayer({ name: "画像 2（音符代わりのきらめき）", src: `${thumbnailPhase4DecorationAssetPrefix}sparkle-small.svg`, x: 612, y: 98, width: 172, height: 150, rotation: -8, opacity: 0.62 }),
      assetDecorationLayer({ name: "画像 3（淡い光粒）", src: `${thumbnailPhase4DecorationAssetPrefix}soft-light-particles.svg`, x: 730, y: 356, width: 430, height: 250, opacity: 0.3 }),
      shapeLayer({ name: "図形 3（立ち絵挿入ガイド）", shapeType: "frame", x: 762, y: 70, width: 418, height: 584, fillColor: "#1608265f", strokeColor: "#ff9fe3", strokeWidth: 3, borderRadius: 34, opacity: 0.92 }),
      ...
      shapeLayer({ name: "図形 4（見出し下ライン）", shapeType: "line", x: 120, y: 430, width: 475, height: 18, fillColor: "#ffb86c", strokeColor: "#ffb86c", strokeWidth: 5, borderRadius: 10, opacity: 0.7 }),
