...
- Start-to-translation smoke execution remains not-run / approval-gated even though FB-L4 now has exact-command ready preflight, PL-G3 records the blocked-no-approval execution gate evidence, PL-G3 follow-up records the post-PL-G2C keep blocked / blocked-no-approval recheck, and PL-G3 after PL-G2K records keep blocked / blocked-missing-start-to-translation-readiness.
