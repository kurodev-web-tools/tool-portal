...
assert.match(thumbnailSource, /data-thumbnail-preset-cta="true"[\s\S]*mt-auto/, "Thumbnail preset CTA is pinned to the card bottom after variable description copy");
