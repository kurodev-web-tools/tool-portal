...
export const portalCopy = {
  ja: {
    ...
    navigation: {
      ...
      comingSoon: "近日対応",
      loginTitle: "アカウントで設定を保存",
      loginBody: "表示言語やテーマなどの共通設定を、ログイン中のアカウントに保存できます。",
  ...
  en: {
    ...
    navigation: {
      ...
      comingSoon: "Planned",
      loginTitle: "Save settings with an account",
      loginBody: "Save shared settings such as language and theme to your signed-in account.",
