...
export function CommentTranslatorPrivateLaunchUnavailable({
  ...
  return (
    ...
    >
      <div className="panel border-primary/30 bg-surface p-5 sm:p-6">
        ...
        <dl className="mt-4 grid gap-2 text-sm">
          <div className="rounded-base border border-primary/30 bg-primary-soft/35 px-3 py-2">
          ...
          <div className="rounded-base border border-border bg-surface/80 px-3 py-2">
            <dt className="text-xs font-black text-muted">{copy.availableNowLabel} / 現在できること</dt>
            <dd className="mt-1 font-semibold leading-6 text-muted">{copy.availableNow}</dd>
          </div>
          <div className="rounded-base border border-border bg-surface/80 px-3 py-2">
            <dt className="text-xs font-black text-muted">{copy.nextStepLabel} / 次の安全な操作</dt>
            <dd className="mt-1 font-semibold leading-6 text-muted">
