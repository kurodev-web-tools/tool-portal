...
export const portalCopy = {
  ja: {
    ...
    navigation: {
      menuOpen: "メニューを開く",
      menuClose: "メニューを閉じる",
      workspaceSidebarExpand: "サイドバーを広げる",
      workspaceSidebarRail: "サイドバーをコンパクト表示",
      workspaceSidebarHide: "サイドバーを隠す",
      workspaceSidebarExpandedShort: "展開",
      workspaceSidebarRailShort: "コンパクト",
      workspaceSidebarHiddenShort: "非表示",
      home: "Home",
      tools: "Tools",
  ...
  en: {
    ...
    navigation: {
      ...
      workspaceSidebarRail: "Use compact sidebar",
      workspaceSidebarHide: "Hide sidebar",
      workspaceSidebarExpandedShort: "Expand",
      workspaceSidebarRailShort: "Compact",
      workspaceSidebarHiddenShort: "Hide",
      home: "Home",
      tools: "Tools",
