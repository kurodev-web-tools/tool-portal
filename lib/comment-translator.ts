...
export const commentTranslatorUiCopy = {
  ja: {
    ...
    fields: {
      ...
      monthlyInputCharacterCap: "月間入力文字上限",
      monthlyRemaining: "入力文字残り",
      stopReason: "停止理由",
      nextAction: "次の操作",
  ...
  en: {
    ...
    fields: {
      ...
      monthlyInputCharacterCap: "Monthly input character cap",
      monthlyRemaining: "input characters remaining",
