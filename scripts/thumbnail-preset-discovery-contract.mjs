...
assert.deepEqual(
  ...
  ["first_stream", "endurance_stream", "project_stream", "karaoke", "chatting", "game_live", "collaboration"],
...
const projectUsageResult = lib.filterThumbnailPresets(lib.thumbnailPresets, {
  query: "",
  category: "all",
  usageLabel: "企画 / 視聴者参加"
});
assert.deepEqual(
  projectUsageResult.map((preset) => preset.id),
  ["project_stream"],
