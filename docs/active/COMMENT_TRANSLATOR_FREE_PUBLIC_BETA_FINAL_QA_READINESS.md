...
- Start-to-translation smoke execution remains incomplete even though FB-L4 now has exact-command ready preflight, PL-G3 records the blocked-no-approval execution gate evidence, PL-G3 follow-up records the post-PL-G2C keep blocked / blocked-no-approval recheck, and PL-G3 after PL-G2K records blocked-stream-unavailable-after-start after status/start/stop retry. Live target lookup, bounded polling, Free Azure translation, and UI/feed confirmation remain not-run / approval-gated.
