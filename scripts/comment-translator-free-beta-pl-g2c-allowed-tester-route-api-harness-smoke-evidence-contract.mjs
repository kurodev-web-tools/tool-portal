...
assert.match(
  task,
  /Current branch: `codex\/comment-translator-free-beta-pl-g2(?:c-route-api-harness-smoke-evidence|d-route-api-harness-smoke-follow-up-after-pl-g5|e-route-api-harness-smoke-execution-gate-after-pl-g2d|f-route-api-harness-smoke-execution-gate-after-pl-g2e|g-route-api-harness-smoke-execution-after-pl-g2f)`/i,
  "task.md records PL-G2C, PL-G2D, PL-G2E, PL-G2F, or PL-G2G branch"
);
