...
assert.match(appSource, /min-h-11 border-b-2 border-primary/, "tool-local live navigation remains touch-safe");
assert.doesNotMatch(appSource, /データ管理/, "unimplemented data management navigation remains hidden");
