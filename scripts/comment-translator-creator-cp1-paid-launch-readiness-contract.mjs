...
for (const marker of [
  /^execution_recorded_at=2026-07-29T01:10:04\+09:00$/m,
  /^reviewed_base=ec8638c29a89ef3c54ee13def91a7d3c591400eb$/m,
  /^approval_id=CP1-A-MIG-C7$/m,
  /^reducer_preflight_retry_approval_id=CP1-A-MIG-C7-REDUCER-PREFLIGHT-RETRY-1$/m,
  /^initial_structural_readiness_approval_id=CP1-A-MIG-C7-STRUCTURAL-READINESS-1$/m,
  /^structural_readiness_completion_approval_id=CP1-A-MIG-C7-STRUCTURAL-READINESS-RETRY-1$/m,
  /^canonical_git_blob=4981ebc2271af05f78661bd0ff3a55ba207b87bf$/m,
  /^canonical_git_blob_sha256=894ca9c6da914a610fd42eff1c6c8a81c1d5c6933626dc9a11d79fc9656a6272$/m,
  ...
  /^synthetic_fixture_count=6$/m,
  /^synthetic_fixture_pass_count=6$/m,
  /^initial_structural_query_attempt_count=1$/m,
  /^structural_readiness_retry_query_attempt_count=1$/m,
  /^structural_query_attempt_count=2$/m,
  /^completion_structural_query_attempt_count=1$/m,
  /^structural_readiness_status=pass$/m,
  ...
  /^next_ordered_approval_unit=CP1-A-MIG-C8$/m,
  /^production_wiring_status=disconnected-fail-closed$/m,
  /^table_present_count=1$/m,
  /^expected_column_present_count=10$/m,
  /^target_table_total_column_count=10$/m,
  /^required_constraint_count=8$/m,
  /^target_table_total_constraint_count=8$/m,
  /^required_index_count=3$/m,
  ...
  /^target_table_total_policy_count=1$/m,
  /^function_present_count=2$/m,
  /^security_definer_function_count=2$/m,
  /^fixed_search_path_count=2$/m,
  /^service_role_function_execute_count=2$/m,
  /^client_function_revoke_count=2$/m,
  /^table_comment_count=1$/m,
...
for (const marker of [
  /^cp1_c7_migration_approval_status=consumed$/m,
  /^cp1_c7_migration_execution_status=pass$/m,
  /^cp1_c7_structural_readiness_status=pass$/m,
]) {
  assert.match(readiness, marker);
}
assert.match(
  board,
  /CP1-A-MIG-C7` is consumed\/pass[\s\S]*zero row-data reads and zero post-apply mutations/,
);
// allow: SIZE_OK — this file is a pure approval-evidence assertion ledger.
for (const marker of [
  /^execution_recorded_at=2026-07-29T01:51:32\+09:00$/m,
  /^reviewed_base=39989805e20880556ecabd0a55405f417a3653d1$/m,
  /^approval_id=CP1-A-MIG-C8$/m,
  /^remote_free_preflight_retry_approval_id=CP1-A-MIG-C8-REMOTE-FREE-PREFLIGHT-RETRY-2$/m,
  /^structural_readiness_completion_approval_id=CP1-A-MIG-C8-STRUCTURAL-READINESS-RETRY-1$/m,
  /^canonical_git_blob=c941657910fae4e215149710fd1407fd026e3d25$/m,
  /^canonical_git_blob_sha256=d1af4f1397c94fcdd56697b85bfc413611867f9dfa1790808f17b98a11a0e3b7$/m,
  /^project_list_attempt_count=1$/m,
  /^accessible_project_count=1$/m,
  /^active_project_count=1$/m,
  /^migration_attempt_count=1$/m,
  ...
  /^initial_structural_query_attempt_count=1$/m,
  /^initial_structural_readiness_status=aborted-reducer-unavailable$/m,
  /^structural_retry_synthetic_fixture_count=6$/m,
  /^structural_retry_synthetic_fixture_pass_count=6$/m,
  /^structural_readiness_retry_query_attempt_count=1$/m,
  /^structural_query_attempt_count=2$/m,
  /^completion_structural_query_attempt_count=1$/m,
  /^structural_readiness_status=pass$/m,
  ...
  /^rollback_status=not-run$/m,
  /^database_cleanup_status=not-run$/m,
  /^next_ordered_approval_unit=CP1-A-MIG-C9$/m,
  /^production_wiring_status=disconnected-fail-closed$/m,
  /^table_present_count=1$/m,
  /^expected_column_present_count=8$/m,
  /^target_table_total_column_count=8$/m,
  /^required_constraint_count=6$/m,
  /^target_table_total_constraint_count=6$/m,
  /^required_index_count=3$/m,
  /^target_table_total_index_count=3$/m,
...
for (const marker of [
  /^cp1_c8_migration_approval_status=consumed$/m,
  /^cp1_c8_migration_execution_status=pass$/m,
  /^cp1_c8_structural_readiness_status=pass$/m,
]) {
  assert.match(readiness, marker);
}
assert.match(
...
for (const marker of [
  /^reviewed_base=6bf0db74a1774b70e1bd95dc0ece9b7b4105080e$/m,
  /^approval_id=CP1-A-MIG-C11-RETRY-3$/m,
  /^payload_reducer_remediation_approval_id=CP1-A-MIG-C11-REMOTE-FREE-PAYLOAD-REDUCER-REMEDIATION-1$/m,
  /^migration_path=supabase\/migrations\/20260723003000_comment_translator_creator_history\.sql$/m,
  /^canonical_git_blob=fb9e53f4dd1d8ddf9a6de63796b7c446051ed793$/m,
  /^canonical_git_blob_sha256=e1d0071176b5e99d0e4934f80480c57b18cbdaf28c46d3df931dc8fef1e75426$/m,
  /^migration_name=comment_translator_creator_history$/m,
  /^structural_query_sha256=f21d3edce436d9de7fc009e7cbd8983e2897364e4e48c97862db3dc887bd26b2$/m,
  /^structural_query_marker=CP1_C11_STRUCTURAL_READINESS_V2$/m,
  /^project_list_attempt_count=1$/m,
  /^accessible_project_count=1$/m,
  /^active_project_count=1$/m,
  /^migration_attempt_count=1$/m,
  ...
  /^migration_status=applied$/m,
  /^transaction_status=committed$/m,
  /^payload_reducer_fixture_group_count=5$/m,
  /^payload_reducer_fixture_group_pass_count=5$/m,
  /^structural_predicate_count=23$/m,
  /^fixed_structural_count_field_count=17$/m,
  /^structural_query_attempt_count=1$/m,
  /^structural_readiness_status=pass$/m,
  /^row_data_read_count=0$/m,
  /^post_apply_mutation_count=0$/m,
  /^execution_status=pass$/m,
  /^sanitized_output_review_status=pass$/m,
  /^database_repair_status=not-run$/m,
  /^rollback_status=not-run$/m,
  /^database_cleanup_status=not-run$/m,
  /^next_ordered_approval_unit=CP1-A-STORE-READINESS$/m,
  /^production_wiring_status=disconnected-fail-closed$/m,
  /^table_present_count=1$/m,
  /^expected_column_present_count=7$/m,
  /^target_table_total_column_count=7$/m,
  /^required_constraint_count=5$/m,
  /^target_table_total_constraint_count=5$/m,
  /^required_index_count=3$/m,
  /^target_table_total_index_count=3$/m,
  /^rls_enabled_count=1$/m,
  /^service_role_table_authority_count=1$/m,
  ...
  /^target_table_total_policy_count=1$/m,
  /^table_comment_count=1$/m,
  /^required_column_comment_count=3$/m,
  /^target_table_total_column_comment_count=3$/m,
]) {
  assert.match(externalEvidenceReconciliation, marker);
}
assert.match(
...
for (const marker of [
  ...
  /^approval_id=CP1-A-STORE-WRITE-READ$/m,
  /^envelope_diagnosis_approval_id=CP1-A-STORE-WRITE-READ-ENVELOPE-DIAGNOSIS$/m,
  /^completing_retry_approval_id=CP1-A-STORE-WRITE-READ-RETRY-3$/m,
  /^proof_surface=C9-direct-table-boundary$/m,
  /^canonical_migration_sha256=f0bf014a4b2ea09af43e34f2a57b7f8458e59915511bb4ca3d2d81c3417325b4$/m,
  /^canonical_store_sha256=5a02f08cebe858fcecdec60fd5410bbd700a79bbd588f04a99180ea33e12ba2a$/m,
  /^proof_query_marker=CP1_A_STORE_WRITE_READ_V1$/m,
  /^remote_free_fixture_count=9$/m,
  /^remote_free_fixture_pass_count=9$/m,
  /^static_predicate_count=10$/m,
  /^static_predicate_pass_count=10$/m,
  /^total_project_list_attempt_count=14$/m,
  /^bounded_proof_sql_attempt_count=4$/m,
  /^non_mutating_diagnostic_sql_attempt_count=9$/m,
  /^prior_unreduced_proof_attempt_count=3$/m,
  /^project_list_attempt_count=1$/m,
  /^accessible_project_count=1$/m,
  /^active_project_count=1$/m,
  /^proof_sql_attempt_count=1$/m,
  /^preexisting_count=0$/m,
  /^write_count=1$/m,
  /^read_count=1$/m,
  /^cleanup_count=1$/m,
  /^residual_count=0$/m,
  ...
  /^database_repair_status=not-run$/m,
  /^rollback_status=not-run$/m,
  /^next_ordered_approval_unit=CP1-A-STRIPE-PRODUCT-PRICE$/m,
  /^production_wiring_status=disconnected-fail-closed$/m,
  /^c1_candidate_proof_count=0\/7$/m,
  /^c1_eligible_candidate_count=0$/m,
]) {
...
const allowedChangedFiles = new Set([
  ...
  "lib/comment-translator-c1-containerless-billing-read.ts",
  "app/api/comment-translator/creator-paid/c1-production-read-proof/route.ts",
  "scripts/comment-translator-creator-c1-container-production-read-contract.mjs",
  "scripts/comment-translator-creator-c1-container-attempt-lifecycle-contract.mjs",
  "scripts/comment-translator-creator-c1-production-durable-read-wiring-contract.mjs",
  "scripts/comment-translator-creator-c1-production-activation-read-proof-contract.mjs",
  "scripts/comment-translator-creator-c1-production-read-proof-route-contract.mjs",
  "scripts/comment-translator-creator-c1-safe-one-read-reducer.mjs",
  "scripts/comment-translator-creator-c1-safe-one-read-reducer-contract.mjs",
  "scripts/comment-translator-creator-c1-cloudflare-presence-reducer.mjs",
  "scripts/comment-translator-creator-c1-cloudflare-presence-reducer-contract.mjs",
  "scripts/comment-translator-creator-c1-containerless-billing-read-contract.mjs",
  ...
  "scripts/comment-translator-creator-c1-containerless-billing-phase-2-prior-migration-state-proof-reducer.mjs",
  "scripts/comment-translator-creator-c1-containerless-billing-phase-2-prior-migration-state-proof.sql",
  ...
  "scripts/comment-translator-creator-c1-containerless-billing-phase-2-remote-readiness-approved-contract.mjs",
  "scripts/comment-translator-creator-c1-containerless-billing-phase-2-remote-readiness-approved.mjs",
  "scripts/comment-translator-creator-c1-containerless-billing-phase-2-remote-readiness-reducer.mjs",
  "scripts/comment-translator-creator-c1-containerless-billing-phase-2-remote-readiness.sql",
